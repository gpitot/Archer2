...
// The content model lives in TooltipContent.ts so the sim can build these
// without pulling the DOM in; re-exported here so existing importers of
// `StatLine` / `TooltipContent` from this module keep working.
import type { StatLine, TooltipContent } from './TooltipContent';

export type { StatLine, TooltipContent } from './TooltipContent';
